...
class LettersController < ApplicationController
  ...
  if @rep_address[@recipient] != nil
    @recipient_address = @rep_address[@recipient].first[:line1] + ", "+ @rep_address[@recipient].first[:city] + ", "+ @rep_address[@recipient].first[:state] + ", "+ @rep_address[@recipient].first[:zip]
